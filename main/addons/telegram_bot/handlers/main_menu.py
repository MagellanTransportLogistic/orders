...
class Form(StatesGroup):
    _end_automates = {
        'text': ['ev_arrive_load', 'ev_arrive_unload', 'ev_arrive_parking', 'ev_leave_parking', 'ev_leave_repair'],
        'text,photo': ['ev_arrive_repair', 'ev_leave_cancel', 'ev_leave_reroute', 'ev_repair_need', 'ev_repair_done',
                       'ev_event_crash', 'ev_event_cargo', 'ev_event_late', 'ev_event_police', 'ev_event_medicine',
                       'ev_change_tg_off', 'ev_change_tg_on', 'ev_change_pc_on', 'ev_change_pc_off', 'ev_work_base',
                       'ev_work_cargo', 'ev_work_vacation', 'ev_work_weekend', 'ev_work_i_can_die'],
        'text,bool,photo': ['ev_leave_load', 'ev_leave_unload'],
        'int': ['ev_money_need'],
        'int,text,photo': ['ev_money_sub', 'ev_fuel_need_by_card', 'ev_fuel_need_by_cash'],
        'int,text': ['ev_money_add', 'ev_fuel_need', 'ev_fuel_not_can', 'ev_fuel_not_station'],
    }
    _end_automates_texts = {
        ...
        'ev_leave_parking': {'text': 'Подробно опишите, зачем вы решили покинуть парковку?'},
        'ev_leave_repair': {'text': 'Опишите, как прошел ремонт?'},

        'ev_arrive_repair': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию ТС'},
        'ev_leave_cancel': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию/скан документа'},
        'ev_leave_reroute': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию/скан документа'},
        'ev_repair_need': {'text': 'Введите комментарий',
                           'photo': 'Приложите фотографию/скан документа для согласования ремонта.'},
        'ev_repair_done': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию/скан документа о ремонте.'},
        'ev_event_crash': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию с места ДТП.'},
        'ev_event_cargo': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию проблем с грузом.'},
        'ev_event_late': {'text': 'Введите комментарий',
                          'photo': 'Приложите скан/фотографию документа, который подтверждает причину задержки.'},
        'ev_event_police': {'text': 'Введите комментарий',
                            'photo': 'Приложите скан/фотографию документа-акта о правонарушении.'},
        'ev_event_medicine': {'text': 'Опишите свое самочувствие',
                              'photo': 'Приложите фотографию/скан медицинского заключения.'},
        'ev_change_tg_off': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию тягача.'},
        'ev_change_tg_on': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию тягача.'},
        'ev_change_pc_on': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию прицепа.'},
        'ev_change_pc_off': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию прицепа.'},
        'ev_work_base': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию.'},
        'ev_work_cargo': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию.'},
        'ev_work_vacation': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию/скан заявления на отпуск.'},
        'ev_work_weekend': {'text': 'Введите комментарий', 'photo': 'Приложите фотографию/скан заявления.'},
        'ev_work_i_can_die': {'text': 'Введите комментарий',
                              'photo': 'Приложите фотографию/скан заключения врача/больничного.'},

        'ev_leave_load': {'text': 'Введите комментарий', 'bool': 'Укажите, есть ли ТТН?',
                          'photo': 'Приложите фотографию/скан заключения врача/больничного.'},
        'ev_leave_unload': {'text': 'Введите комментарий', 'bool': 'Укажите, есть ли ТТН?',
                            'photo': 'Приложите фотографию/скан заключения врача/больничного.'},

        'ev_money_need': {'int': 'Введите сумму, которая вам требуется'},

        'ev_money_sub': {'int': 'Введите сумму расхода', 'text': 'Комментарий',
                         'photo': 'Приложите скан/фото расходного документа'},
        'ev_fuel_need_by_card': {'int': 'Введите требуемое количество топлива', 'text': 'Комментарий',
                                 'photo': 'Приложите скан/фото'},
        'ev_fuel_need_by_cash': {'int': 'Введите требуемое количество топлива', 'text': 'Комментарий',
                                 'photo': 'Приложите скан/фото'},
...
async def cmd_im_arrive(callback: types.CallbackQuery, state: FSMContext):
    ...
    builder.add(types.InlineKeyboardButton(
        text="На загрузку",
        callback_data="ev_arrive_load"))
    builder.add(types.InlineKeyboardButton(
        text="На выгрузку",
        callback_data="ev_arrive_unload"))
    builder.add(types.InlineKeyboardButton(
        text="На стоянку",
        callback_data="ev_arrive_parking"))
    builder.add(types.InlineKeyboardButton(
        text="На ремонт",
...
async def cmd_im_leave(callback: types.CallbackQuery, state: FSMContext):
    ...
    builder.add(types.InlineKeyboardButton(
        text="Загрузился",
        callback_data="ev_leave_load"))
    builder.add(types.InlineKeyboardButton(
        text="Выгрузился",
        callback_data="ev_leave_unload"))
    builder.add(types.InlineKeyboardButton(
        text="Со стоянки",
        callback_data="ev_leave_parking"))
    builder.add(types.InlineKeyboardButton(
        text="C ремонта",
        callback_data="ev_leave_repair"))
    builder.add(types.InlineKeyboardButton(
        text="Отмена загрузки",
        callback_data="ev_leave_cancel"))
    builder.add(types.InlineKeyboardButton(
        text="Переадресация",
...
async def cmd_im_leave(callback: types.CallbackQuery, state: FSMContext):
    ...
    builder.add(types.InlineKeyboardButton(
        text="Нужны деньги",
        callback_data="ev_money_need"))
    builder.add(types.InlineKeyboardButton(
        text="Расход",
        callback_data="ev_money_sub"))
    builder.add(types.InlineKeyboardButton(
        text="Приход",
...
async def cmd_im_leave(callback: types.CallbackQuery, state: FSMContext):
    ...
    builder.add(types.InlineKeyboardButton(
        text="Нужна заправка",
        callback_data="ev_fuel_need"))
    builder.add(types.InlineKeyboardButton(
        text="По топл. карте",
        callback_data="ev_fuel_need_by_card"))
    builder.add(types.InlineKeyboardButton(
        text="За наличные",
        callback_data="ev_fuel_need_by_cash"))
    builder.add(types.InlineKeyboardButton(
        text="Не в бак",
        callback_data="ev_fuel_not_can"))
    builder.add(types.InlineKeyboardButton(
        text="Не на АЗС",
...
async def cmd_im_leave(callback: types.CallbackQuery, state: FSMContext):
    ...
    builder.add(types.InlineKeyboardButton(
        text="ДТП",
        callback_data="ev_event_crash"))
    builder.add(types.InlineKeyboardButton(
        text="Проблема с грузом",
        callback_data="ev_event_cargo"))
    builder.add(types.InlineKeyboardButton(
        text="Задержка в пути",
        callback_data="ev_event_late"))
    builder.add(types.InlineKeyboardButton(
        text="Правонарушение",
        callback_data="ev_event_police"))
    builder.add(types.InlineKeyboardButton(
        text="Медпомощь",
...
async def cmd_im_leave(callback: types.CallbackQuery, state: FSMContext):
    ...
    builder.add(types.InlineKeyboardButton(
        text="Тягач сдал",
        callback_data="ev_change_tg_off"))
    builder.add(types.InlineKeyboardButton(
        text="Тягач принял",
        callback_data="ev_change_tg_on"))
    builder.add(types.InlineKeyboardButton(
        text="Прицеп сдал",
        callback_data="ev_change_pc_on"))
    builder.add(types.InlineKeyboardButton(
        text="Прицеп сдал",
...
async def cmd_im_leave(callback: types.CallbackQuery, state: FSMContext):
    ...
    builder.add(types.InlineKeyboardButton(
        text="Работа на базе",
        callback_data="ev_work_base"))
    builder.add(types.InlineKeyboardButton(
        text="Работа с грузом",
        callback_data="ev_work_cargo"))
    builder.add(types.InlineKeyboardButton(
        text="Запрос на отпуск",
        callback_data="ev_work_vacation"))
    builder.add(types.InlineKeyboardButton(
        text="Нужен выходной",
        callback_data="ev_work_weekend"))
    builder.add(types.InlineKeyboardButton(
        text="Больничный",
